...
const ELEMENTOS = [
  ...
  { tipoDano: "impacto", chave: "agua", nome: "Água", dano: [4, 4, 4], extras: [escala("Molhado", 1, 1)],
    desc: "Adiciona dados ao próximo dano de Frio que o alvo receber, iguais ao Molhado acumulado." },
  { tipoDano: "frio", chave: "gelo", nome: "Gelo", dano: [4, 2, 8], extras: [escala("Friagem", 1, 1)],
    desc: "O alvo sofre Friagem por 1 minuto: cada reação custa Friagem² de estamina a mais." },
  { tipoDano: "impacto", chave: "vento", nome: "Vento", dano: [4, 4, 4], extras: [escala("Empurrão", 1, 1)],
    desc: "Empurra o alvo. Contra uma parede, causa 1d10 adicional para cada metro que restar." },
  { tipoDano: "impacto", chave: "terra", nome: "Terra", dano: [3, 2, 12], extras: [escala("Defesa Física", 1, 1)],
    desc: "Quem conjura recebe Defesa Física adicional até o fim do próximo turno." },
  ...
  { tipoDano: "mental", chave: "mente", nome: "Mente", dano: [1, 1, 6], extras: [escala("Condições", 1, 1)],
